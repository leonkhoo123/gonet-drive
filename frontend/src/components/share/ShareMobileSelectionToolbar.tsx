...
interface ShareMobileSelectionToolbarProps {
...
export default function ShareMobileSelectionToolbar({
  selectedItemsSize,
  onCancel,
  onSelectAll,
  onCut,
  ...
  authority,
}: ShareMobileSelectionToolbarProps) {
  if (selectedItemsSize === 0) return null;

  return (
    <div className="md:hidden h-14 flex items-center justify-between px-2 border-b bg-gradient-to-r from-background via-primary/[0.02] to-background shrink-0 overflow-x-auto">
