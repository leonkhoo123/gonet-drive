...
func TestListShares_OnlyOwnShares(t *testing.T) {
	...
	var listResp map[string]interface{}
	require.NoError(t, json.Unmarshal(recBob.Body.Bytes(), &listResp))
...
func TestToggleBlock_Success(t *testing.T) {
	...
	require.NoError(t, json.Unmarshal(rec2.Body.Bytes(), &toggleResp))
	...
	var toggleResp2 map[string]interface{}
	require.NoError(t, json.Unmarshal(rec3.Body.Bytes(), &toggleResp2))
